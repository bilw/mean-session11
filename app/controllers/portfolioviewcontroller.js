  portfolioApp.controller("PortfolioViewerController", function($scope, $routeParams, FIREBASE_URL, $firebaseArray, $firebaseObject){
    ...
    var portfolio_name = $routeParams.portfolio_name; // defines portfolio_name witin routeParams
  	var pushImg = new Firebase(FIREBASE_URL + '/images/' + portfolio_name);  // extends path in firebase down into each portfolio key within images
